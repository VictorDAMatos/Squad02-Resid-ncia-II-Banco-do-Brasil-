...
from app.api.routers import clientes, transacoes, inteligencia, analista, core_bancario, anomalies, registros, usuario
...
def root():
    return {
        ...
        "painel_analista": "/static/analista/dashboard.html",
        "swagger": "/docs",
        "scalar": "/scalar",
