...
def inicializar_tabelas_fraude(conexao: Optional[sqlite3.Connection] = None) -> None:
    ...
    # Campos da IA integrados na US05, sem remover a estrutura original.
    garantir_coluna(conexao, "transactions", "latitude", "REAL DEFAULT 0")
    garantir_coluna(conexao, "transactions", "longitude", "REAL DEFAULT 0")
    garantir_coluna(conexao, "transactions", "tentativas", "INTEGER DEFAULT 1")
    garantir_coluna(conexao, "transactions", "estado", "TEXT DEFAULT 'PE'")
    garantir_coluna(conexao, "transactions", "pais", "TEXT DEFAULT 'Brasil'")
    garantir_coluna(conexao, "transactions", "dia_semana", "TEXT")
    garantir_coluna(conexao, "transactions", "ia_anomalia", "INTEGER DEFAULT 0")
    garantir_coluna(conexao, "transactions", "ia_score", "REAL")
    garantir_coluna(conexao, "transactions", "ia_risco", "INTEGER DEFAULT 1")
    garantir_coluna(conexao, "transactions", "ia_motivo", "TEXT")
    garantir_coluna(conexao, "transactions", "ia_processado_em", "TEXT")
